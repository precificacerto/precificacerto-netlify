-- =============================================================================
-- Trial 14 dias e approved_by_super_admin na criação de tenant
-- =============================================================================

-- 1. create_tenant_with_admin: setar trial_ends_at e approved_by_super_admin
...
-- 2. handle_new_auth_user: no Caso 3 (signup), setar trial_ends_at e approved_by_super_admin
...
BEGIN
  ...
  -- Caso 3: Novo cadastro (signup) = cria tenant e super admin — trial 14 dias, aprovação manual
  INSERT INTO public.tenants (
    name, cnpj_cpf, segment, email, phone,
    cep, street, number, complement, neighborhood, city, state_code,
    trial_ends_at, approved_by_super_admin
