...
export const CASHIER_CATEGORY = {
  ...
  EXPENSE: {
    ...
    DECIMO_TERCEIRO_PRODUCAO: {
      ...
      value: 'Décimo Terceiro (produção)',
      group: 'MAO_DE_OBRA' as ExpenseGroupKey,
    },
    FERIAS_COLABORADORES_PRODUCAO: {
      order: 14,
      key: 'FERIAS_COLABORADORES_PRODUCAO',
      value: 'Férias Colaboradores (produção)',
      group: 'MAO_DE_OBRA' as ExpenseGroupKey,
    },
    FGTS_PRODUCAO: { order: 15, key: 'FGTS_PRODUCAO', value: 'FGTS (Produção)', group: 'MAO_DE_OBRA' as ExpenseGroupKey },
    INSS_PRODUCAO: { order: 16, key: 'INSS_PRODUCAO', value: 'INSS (Produção)', group: 'MAO_DE_OBRA' as ExpenseGroupKey },
    PLANO_DE_SAUDE_PRODUCAO: {
      order: 17,
      key: 'PLANO_DE_SAUDE_PRODUCAO',
      value: 'Plano de Saúde (Produção)',
      group: 'MAO_DE_OBRA' as ExpenseGroupKey,
    },
    VALE_ALIMENTACAO_PRODUCAO: {
      order: 18,
      key: 'VALE_ALIMENTACAO_PRODUCAO',
      value: 'Vale Alimentação (Produção)',
      group: 'MAO_DE_OBRA' as ExpenseGroupKey,
    },
    VALE_TRANSPORTE_PRODUCAO: {
      order: 19,
      key: 'VALE_TRANSPORTE_PRODUCAO',
      value: 'Vale Transporte (Produção)',
      group: 'MAO_DE_OBRA' as ExpenseGroupKey,
    },
