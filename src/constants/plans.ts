...
export const PLANS_ACIMA_200K: PlanOption[] = [
  {
    ...
    name: 'Individual',
    price: 299.9,
    description: 'Até 3 usuários • Para operações maiores',
    maxUsers: 3,
    features: [
      'Até 3 usuários',
  ...
  },
  {
    ...
    name: 'Intermediário',
    price: 399.9,
    description: 'Até 5 usuários • Para times comerciais',
    maxUsers: 5,
    features: [
      'Até 5 usuários',
  ...
  },
  {
    ...
    name: 'Pro',
    price: 499.9,
    description: 'Até 7 usuários • Para equipes comerciais maiores',
    maxUsers: 7,
    features: [
      'Até 7 usuários',
