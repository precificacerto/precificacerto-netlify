...
function Items() {
  ...
  /**
   * §2 — A GRAVAÇÃO MORA EM `gravar-item.ts`, e as duas telas chamam de lá.
   *
   * Aqui fica só o que é de TELA: validar, resolver tenant e usuário, recarregar o cache,
   * abrir o modal de impacto e mostrar a mensagem. Eram 304 linhas; copiá-las para o
   * Estoque daria dois caminhos de gravação para o mesmo cadastro.
   */
      ...
      const r = await gravarItem(
        {
          ...
          aoMudarCredito: ({ itemId, nome, custoAntes, custoDepois }) =>
            void levantarImpacto(itemId, nome, custoAntes, custoDepois),
        },
        values,
      )
