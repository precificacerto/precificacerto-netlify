            ...
            <Form form={taxForm} layout="vertical">
                ...
                {regime && !isMei && (
                    ...
                    <>
                        ...
                        >
                            <PercentInput min={0} max={100} style={{ width: '100%', maxWidth: 220 }} />
                        </Form.Item>
                        ...
                        >
                            <PercentInput min={0} max={10} style={{ width: '100%', maxWidth: 220 }} />
                        </Form.Item>
                            ...
                            <>
                                ...
                                <div style={{ marginTop: 16, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 12 }}>
                                    <Form.Item name="iss_municipality_rate" label="ISS Municipal (%)">
                                        <PercentInput min={0} max={10} style={{ width: '100%' }} />
                                    </Form.Item>
